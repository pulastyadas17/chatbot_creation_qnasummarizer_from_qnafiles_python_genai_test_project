# -*- coding: utf-8 -*-
"""Chatbot_Creation_Summarization_from_qnafiles_streamlitUI.ipynb
...
!pip install streamlit pyngrok pdfplumber openpyxl sentence-transformers

ngrok.set_auth_token("2vwSqEAHAnrYervsgU2mUy2Nzyz_3jwnRBxKHmCSGZCPFqKTh")
